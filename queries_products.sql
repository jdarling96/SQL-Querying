...
INSERT INTO products (name,price, can_be_returned) VALUES('mattress', 200.00, true);
...
--There is a new company policy: everything is returnable. Update the database accordingl
UPDATE products SET pricecan_be_returne^Z price + 20.00;
